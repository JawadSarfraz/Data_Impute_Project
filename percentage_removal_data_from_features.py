...
# Remove data based on a given percentage and seed
...
for filename in filenames:
    ...
    # Get the column labels from the filename
    columns = re.findall(r'combination_\d+_([A-Z]+).xlsx', filename)[0]
    # Generate combinations of given columns (up to the number of columns in the file)
